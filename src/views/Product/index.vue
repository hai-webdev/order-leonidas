...
export default {
  ...
  async created() {
    if (!this.scodeInfo) {
      this.$store.dispatch("product/asyncSetData", this.$route.meta.scode);
    }
    ...
    document.title = this.$store.state.product.scodeInfo.name;
    this.total = resp.total;
    this.productList = resp.data;
  },
  computed: {
    ...mapState("product", ["scodeInfo", "loading"]),
  },
};
</script>
